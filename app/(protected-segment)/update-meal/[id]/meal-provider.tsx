...
export default function MealDataContextProvider({ children, initialValue }: PropsWithChildren<{
  initialValue: { name: string, foods: FoodDTO[] }
}>) {
  const [mealData, setMealData] = React.useState<{ name: string, foods: FoodDTO[] }>(initialValue)
  return (
